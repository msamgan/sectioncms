...
export default function DependentMenu({ menuItems, itemKey, index }) {
    ...
    return (
        ...
        >
            ...
            <ul
                className={`absolute left-0 top-full w-full mt-2 py-2 border border-gray-100 rounded-lg bg-white shadow-sm z-10 transition-all duration-300 ease-in-out ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2 pointer-events-none'}`}
            >
