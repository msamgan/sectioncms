...
export default function DependentMenu({ menuItems, itemKey, index }) {
    ...
    return (
        <li
            ...
            className={
                isActive
                    ? 'relative py-2.5 px-5 text-primary bg-purple-50 rounded-lg shadow-sm font-medium transition-all duration-300 ease-in-out border border-purple-100'
                    : 'relative py-2.5 px-5 text-gray-700 hover:text-primary hover:bg-purple-50 rounded-lg transition-all duration-300 ease-in-out hover:shadow-sm hover:border hover:border-purple-100'
            }
        >
                    ...
                    <li
                        ...
                        className={
                            route().current(item.route)
                                ? 'flex items-center py-2 px-4 mx-2 my-1 text-primary bg-purple-50 rounded-md shadow-sm font-medium transition-all duration-300 ease-in-out border border-purple-100'
                                : 'flex items-center py-2 px-4 mx-2 my-1 text-gray-700 hover:text-primary hover:bg-purple-50 rounded-md transition-all duration-300 ease-in-out hover:shadow-sm hover:border hover:border-purple-100'
                        }
                    >
