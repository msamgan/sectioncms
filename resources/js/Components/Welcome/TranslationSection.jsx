    ...
    return (
        <div className="py-12 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
            ...
            <div className="mt-16 max-w-4xl mx-auto">
                <h3 className="text-2xl font-bold text-center text-gray-900 mb-6">How the platform works</h3>
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    {/* Step 1 */}
                    <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200 hover:-translate-y-1">
                        ...
                        <p className="text-gray-600 text-sm">Sign up and get access to the content management system</p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200 hover:-translate-y-1">
                        <div className="flex items-center mb-4">
                            ...
                            <h4 className="font-medium text-gray-900">Create sections</h4>
                        </div>
                        <p className="text-gray-600 text-sm">Add sections like "Home Page - Hero" to organize content</p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200 hover:-translate-y-1">
                        <div className="flex items-center mb-4">
                            ...
                            <h4 className="font-medium text-gray-900">Add translation keys</h4>
                        </div>
                        <p className="text-gray-600 text-sm">Create keys like "title" with values in different languages</p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200 hover:-translate-y-1">
                        <div className="flex items-center mb-4">
                            ...
                            <h4 className="font-medium text-gray-900">Use in your API</h4>
                        </div>
                        <p className="text-gray-600 text-sm">API returns values in the selected language automatically</p>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <div>
                            <div className="bg-white p-3 rounded border border-gray-100 mb-2">
                                <p className="text-sm font-medium text-gray-700">1. Create section: <span className="text-primary">Home Page - Hero</span></p>
                            </div>
                            <div className="bg-white p-3 rounded border border-gray-100">
                                <p className="text-sm font-medium text-gray-700">2. Add key: <span className="text-primary">title</span></p>
                                <div className="mt-2 pl-4 border-l-2 border-blue-200">
                                    <p className="text-xs text-gray-600">English (en): <span className="font-medium">Welcome to XYZ</span></p>
                                    <p className="text-xs text-gray-600">Spanish (es): <span className="font-medium">Bienvenido a XYZ</span></p>
                                </div>
                            </div>
                        </div>
                        <div>
