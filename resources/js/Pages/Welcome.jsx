                            ...
                            <nav className="-mx-3 flex flex-1 justify-end">
                                {auth.user ? (
                                    <Link
                                        ...
                                        className="ring-transparent rounded-md px-3 py-2 text-black ring-1 transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    >
                                        Dashboard
                                    </Link>
                                ) : (
                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <div className="from-transparent dark:via-zinc-900 dark:to-zinc-900 absolute -bottom-16 -left-16 h-40 w-[calc(100%+8rem)] bg-gradient-to-b via-white to-white"></div>
                                    </div>
