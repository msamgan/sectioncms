    ...
    return (
        <form onSubmit={submit} className="space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6 transition-all duration-300 hover:shadow-lg">
                <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 px-6 py-4">
                    <div className="flex items-center">
                        ...
                        <h5 className="ml-3 text-lg font-semibold text-gray-800 dark:text-gray-200">General information</h5>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <i className="ri-building-line text-gray-500 dark:text-gray-400"></i>
                                </div>
                                <TextInput
                                    type="text"
                                    value={data.name}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <select
                                    id="country_region"
                                    className="w-full pl-10 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 transition-all duration-300 dark:bg-gray-700 dark:text-gray-300"
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <i className="ri-map-pin-line text-gray-500 dark:text-gray-400"></i>
                                </div>
                                <TextInput
                                    type="text"
                                    id="bill_address"
                        ...
                        <div className="space-y-2 md:col-span-2 lg:col-span-1">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <i className="ri-map-2-line text-gray-500 dark:text-gray-400"></i>
                                        </div>
                                        <TextInput
                                            type="text"
                                            id="bill_state"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <i className="ri-hashtag text-gray-500 dark:text-gray-400"></i>
                                        </div>
                                        <TextInput
                                            type="number"
                                            id="bill_pincode"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-6 transition-all duration-300 hover:shadow-lg">
                <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 px-6 py-4">
                    <div className="flex items-center">
                        ...
                        <div className="ml-3">
                            <h5 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Time zone</h5>
                ...
                <div className="p-6 dark:text-gray-300">
                    <div className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <i className="ri-time-line text-gray-500 dark:text-gray-400"></i>
                                </div>
                                <select
                                    id="timeZones"
                                    className="w-full pl-10 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 transition-all duration-300 dark:bg-gray-700 dark:text-gray-300"
            ...
            <div className="flex justify-end items-center gap-5">
                <button
                    disabled={processing}
                    className="inline-flex items-center px-5 py-3 bg-primary dark:bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-secondary dark:hover:bg-blue-700 focus:bg-primary-dark dark:focus:bg-blue-800 active:bg-primary-dark dark:active:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150 shadow-sm hover:shadow-md disabled:opacity-25"
                >
