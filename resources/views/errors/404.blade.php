    ...
    <body>
        <section class="">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div
                    class="inline-flex w-full flex-col items-center justify-start gap-10 pb-12 pt-12 lg:gap-16 lg:pb-28 lg:pt-[180px]"
                >
                    <div class="relative mt-12 flex h-[calc(550px-85px)] flex-col items-center justify-center">
                        <svg
                            width="314"
                            height="171"
                            viewBox="0 0 314 171"
                        ...
                        <div class="mt-5 block text-center">
                            ...
                            <p class="text-sm text-gray-500">Check the URL or return to the homepage.</p>
                        </div>
                    </div>
                    <a
                        href="{{ url('/') }}"
