...
<html>
    ...
    <body>
        <div class="flex h-screen w-screen flex-col items-center justify-center gap-12 py-8">
            <svg class="aspect-video h-[50vh]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                ...
                <g id="freepik--security-barrier--inject-3">
                    <polygon
                        ...
                        style="fill: #263238; stroke: #263238; stroke-miterlimit: 10; stroke-width: 1px"
                    ></polygon>
                    <polygon
                        points="115.39 446.5 129.64 446.5 110.63 313.99 96.38 313.99 115.39 446.5"
                        style="fill: #fff; stroke: #263238; stroke-miterlimit: 10; stroke-width: 1px"
                    ></polygon>
                    <polygon
                    ...
                    <rect
                        ...
                        width="271.93"
                        height="26.36"
                        style="fill: #3b82f6; stroke: #263238; stroke-miterlimit: 10; stroke-width: 1px"
                    ></rect>
                    <rect
                        x="62.36"
                        y="293.21"
                    ...
                    <line
                        ...
                        x2="287.8"
                        y2="304.9"
                        style="fill: none; stroke: #263238; stroke-miterlimit: 10; stroke-width: 1px"
                    ></line>
                    <line
                        x1="332.01"
                        y1="309.31"
